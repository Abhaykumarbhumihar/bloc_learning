import 'package:bloc_learning/pages/signUp/sign_up_controller.dart';
            ...
            body: SingleChildScrollView(
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Center(
                      child: resuableText("Enter your details below & free sign up")),
                  Container(
                    margin: EdgeInsets.only(top: ScreenUtils.height(context) * 0.08),
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Center(
                            child: resuableText("By creating an account you have to agree with our term & condition")),
                        SizedBox(
